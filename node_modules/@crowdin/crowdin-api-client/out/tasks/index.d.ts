...
export declare class Tasks extends CrowdinApi {
     ...
     */
    addTask(projectId: number, request: TasksModel.CreateTaskRequest | TasksModel.CreateTaskVendorOhtRequest | TasksModel.CreateTaskVendorGengoRequest | TasksModel.CreateTaskVendorTranslatedRequest): Promise<ResponseObject<TasksModel.Task>>;
